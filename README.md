...
> [!CAUTION]
> Skwd-wall now uses my own Skwd-paper wallpaper software. It has been extremely stable in testing, but please report if something isn't working as expected.
